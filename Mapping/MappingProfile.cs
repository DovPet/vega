...
namespace vega.Mapping
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<State, KeyValuePairResource>();
            CreateMap<ParkingLot, KeyValuePairResource>();
            CreateMap<Vehicle, KeyValuePairResource>();
